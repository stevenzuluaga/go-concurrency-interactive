    ...
    <div className="flex flex-col gap-8 p-8">
      <div className="space-y-2">
        ...
        <p className="text-lg text-muted-foreground">
          Las goroutines son la forma de Go para ejecutar funciones de forma
          concurrente
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <p className="text-muted-foreground">
          Una goroutine es un thread gestionado por el runtime de Go. Son
          extremadamente ligeras: puedes tener miles o millones ejecutándose
          simultáneamente. Están multiplexadas en múltiples threads del SO, lo
          que permite que Go ejecute código concurrente de forma eficiente.
        </p>
      </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            La palabra clave{" "}
            <code className="rounded bg-muted px-2 py-1">go</code> antes de una
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4 rounded-lg border border-border bg-card p-6">
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li>
              ✓ Sintaxis simple: solo{" "}
              <code className="rounded bg-muted px-1">go</code>
            </li>
        ...
        <div className="space-y-3">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Se crea con{" "}
                <code className="rounded bg-muted px-1">go function()</code>
              </p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                El scheduler la coloca en un thread disponible y comienza a
                ejecutarse
              </p>
            </div>
          </div>
      ...
      <div className="space-y-4 rounded-lg border border-border bg-card p-6">
        ...
        <ul className="space-y-3 text-muted-foreground">
          <li className="flex gap-2">
            ...
            Siempre espera a que terminen las goroutines antes de que main()
            salga
          </li>
          <li className="flex gap-2">
            <span className="text-primary font-bold">•</span>
          ...
          <li className="flex gap-2">
            <span className="text-primary font-bold">•</span>
            Usa goroutines para operaciones I/O o CPU-bound que se pueden
            paralelizar
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Visualización teórica de uso de recursos
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              Go runtime scheduler automáticamente multiplexea goroutines en OS
              threads disponibles, proporcionando un modelo de programación
              concurrente ultra-eficiente.
            </p>
          </CardContent>
        </Card>
